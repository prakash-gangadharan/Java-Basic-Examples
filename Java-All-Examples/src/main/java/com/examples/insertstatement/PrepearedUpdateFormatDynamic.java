...
class TestUpdateQuerry {
	...
	public void getTimeFromTable(Connection con) {
		...
		try {
			int a= -330;
			// Variant 1
			sbQuery.append("UPDATE date_format_tester SET start_time = ?::TIME + ?::INTERVAL");
			//sbQuery.append("INSERT INTO date_format_tester(start_time) values (? + ?::INTERVAL)");
			pstmt = con.prepareStatement(sbQuery.toString());
			pstmt.setString(1, "10:00:00");
...
public class PrepearedUpdateFormatDynamic {
	...
	public static void main(String[] args) {
		...
		TestUpdateQuerry primaryClass = new TestUpdateQuerry();
